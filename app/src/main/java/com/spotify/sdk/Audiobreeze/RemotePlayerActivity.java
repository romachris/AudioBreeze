...
public class RemotePlayerActivity extends FragmentActivity {
    private  static String URI_PLAY;
    ...
    private static final String TRACK_URI = "spotify:track:0xMd5bcWTbyXS7wPrBtZA6";
    ...
    protected void onCreate(final Bundle savedInstanceState) {
        URI_PLAY= getIntent().getStringExtra("uri");
        System.out.println(URI_PLAY);
    ...
    private void onConnected() {
        ...
        mConnectAuthorizeButton.setText(R.string.connected);
            ...
            onPlayPlaylistButtonClicked(findViewById(R.id.play_track_button));
